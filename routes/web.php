...
Route::middleware('auth')->group(function () {
    ...
    Route::put('/customer/{id}', 'App\Http\Controllers\Web\HomeController@updateCustomer')->whereNumber('id');
    ...
    Route::put('/currency/{id}', 'App\Http\Controllers\Web\HomeController@updateCurrency')->whereNumber('id');
    ...
    Route::put('/payment-gateway/{id}', 'App\Http\Controllers\Web\HomeController@updateGateway')->whereNumber('id');
    ...
    Route::put('/vehicle/{id}', 'App\Http\Controllers\Web\HomeController@updateVehicle')->whereNumber('id');
    ...
    Route::put('/vehicle/{entity}/{id}', 'App\Http\Controllers\Web\HomeController@updateVehicleEntity')->whereNumber('id');
    ...
    Route::put('/role/{id}', 'App\Http\Controllers\Web\HomeController@updateRole')->whereNumber('id');
    ...
    Route::put('/role/{entity}/{id}', 'App\Http\Controllers\Web\HomeController@updateRoleEntity')->whereNumber('id');
    ...
    Route::put('/status/{id}', 'App\Http\Controllers\Web\HomeController@updateStatus')->whereNumber('id');
    ...
    Route::put('/account', 'App\Http\Controllers\Web\AccountController@updateAccount');
    Route::get('/account/{entity}', 'App\Http\Controllers\Web\AccountController@accountEntity')->name('account.entity');
    Route::put('/account/{entity}', 'App\Http\Controllers\Web\AccountController@updateAccountEntity');
});
