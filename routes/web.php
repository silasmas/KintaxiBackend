...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('/customer/{id}', 'App\Http\Controllers\Web\CustomerController@destroy')->whereNumber('id')->name('customer.destroy');
    ...
    Route::delete('/currency/{id}', 'App\Http\Controllers\Web\CurrencyController@destroy')->whereNumber('id')->name('currency.destroy');
    ...
    Route::delete('/payment-gateway/{id}', 'App\Http\Controllers\Web\PaymentGatewayController@destroy')->whereNumber('id')->name('payment_gateway.destroy');
    ...
    Route::delete('/vehicle/{id}', 'App\Http\Controllers\Web\VehicleController@destroy')->whereNumber('id')->name('vehicle.destroy');
    ...
    Route::delete('/vehicle/{entity}/{id}', 'App\Http\Controllers\Web\VehicleController@destroyEntity')->whereNumber('id')->name('vehicle.entity.destroy');
    ...
    Route::delete('/role/{id}', 'App\Http\Controllers\Web\RoleController@destroy')->whereNumber('id')->name('role.destroy');
    ...
    Route::delete('/role/{entity}/{id}', 'App\Http\Controllers\Web\RoleController@destroyEntity')->whereNumber('id')->name('role.entity.destroy');
    ...
    Route::delete('/status/{id}', 'App\Http\Controllers\Web\StatusController@destroy')->whereNumber('id')->name('status.destroy');
    // Account
